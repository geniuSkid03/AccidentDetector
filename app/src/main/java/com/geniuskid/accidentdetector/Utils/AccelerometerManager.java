...
public class AccelerometerManager {
    ...
    private static AcceleraMeterListener listener;
     ...
     */
    public static void startListening(AcceleraMeterListener accelerometerListener )
    {
    ...
    public static void startListening(
            AcceleraMeterListener accelerometerListener,
